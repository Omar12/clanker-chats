...
When I ran this at Netflix while leading a cross-platform launch, I was running 7 initiatives in parallel.
...
When I started using this system at Amazon, I went from drowning in 20+ hours of meetings a week to feeling in control.
...
## **3. How to Set It Up (Notion Example)**

If you prefer Notion:
1. Create a “Daily Notes” database.
2. Each note has a “Content” text field.
3. Create three linked database views:
   - **Actions View**: Filter “Content” contains `A:`
   - **Decisions View**: Filter “Content” contains `D:`
   - **Risks View**: Filter “Content” contains `R:`
4. Bonus: Add columns for **Owner**, **Due Date**, and **Status** so you can track progress.
...
When I used this at Netflix, I’d walk into staff meetings with a “magically” up-to-date list of all open actions and recent decisions.  
